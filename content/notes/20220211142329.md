...
#### 💡考察: Component/MountとIntegrantの決定的違い {#考察-component-mountとintegrantの決定的違い}
...
初期化時に自前でatomに保存しておく方法は そもそもフレームワークで状態を管理する考えに反するアンチパターン.

Integrantはより関数型プログラミングの考えに近い.
