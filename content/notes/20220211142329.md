...
systemというひとつの状態に紐づけてまとめることができる. そしてこのツリー構造で状態を管理するからこそシステムの停止や再起動が用意にできる.
...
haltはオブジェクトを [Command Pattern]({{< relref "20220309184220.md#command-pattern" >}}) で扱うようなものとして捉えれば納得がいく.
