...
[📝Logseq]({{< relref "20220601092517.md" >}}) との連携が便利かも.

ガッツリ調査しはじめた -> [Logseq /Org-roam連携]({{< relref "20220601092517.md#logseq-org-mode-org-roam連携" >}})

ref. [Taking org-roam everywhere with logseq • Core Dumped](https://coredumped.dev/2021/05/26/taking-org-roam-everywhere-with-logseq/)
