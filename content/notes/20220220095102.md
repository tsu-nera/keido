...
[迫り来る Web3.0 時代を生き抜くエンジニアが持たなければいけない 3 つの視点 | DMTC Magazine](http://dmtc.jp/magazine/?p=1461)
...
インターネット (もしくはイントラネット) などのネットワークを介して使用するアプリケーションソフトウェア.(cf. Desktop Application, Mobile Application)
