...
## On-Demmand Access {#on-demmand-access}
...
## ASS Classification {#ass-classification}
...
## Client-Server Sytems {#client-server-sytems}
...
#### クラウドコンピューティングとの比較 {#クラウドコンピューティングとの比較}
...
### Quorum (consistency level) {#quorum--consistency-level}
...
### Mutual Exceptions {#mutual-exceptions}
...
## Clock Syncronization {#clock-syncronization}
...
## Global Snapshot {#global-snapshot}

分散システムにおけるそのときの状態.


### liveness & Safety {#liveness-and-safety}
...
#### Intel - Software Defined Infrastructure (SDI) {#intel-software-defined-infrastructure--sdi}
...
#### Cisco - Software Defined Network (SDN) {#cisco-software-defined-network--sdn}
...
#### EMC - Software Defined Storage (SDS) {#emc-software-defined-storage--sds}

EMC のとなえる戦略. ストレージにおける Software Defined.


### 実現するための技術・ OSS {#実現するための技術-oss}
...
## Software Defined Archtecture {#software-defined-archtecture}

サービスをorchestrationしたりprovisioningしたりするメカニズム.


### Software Defined Infrastructe {#software-defined-infrastructe}
...
### Rack Scale Architecture (RSA) {#rack-scale-architecture--rsa}
