...
-   Luminus
-   [Duct]({{< relref "20220211142329.md#clojure-duct" >}}) (正確には状態管理ライブラリ + モジュール作成テンプレート).
...
Clojureにおける [Web サーバ抽象]({{< relref "20220220095102.md#web-server-abstruction" >}}) のデファクトスタンダード.
...
### ring-json: middleware {#ring-json-middleware}
...
-   refs
    -   [Clojure: clojure.lang.Var]({{< relref "20220116080418.md#clojure-clojure-dot-lang-dot-var" >}})
    -   [💡 def macro / alter-var-rootによるvarの再定義]({{< relref "20220116080418.md#def-macro-alter-var-rootによるvarの再定義" >}})
...
Firestoreは[スキーマレスDB]({{< relref "20220311163333.md#スキーマレスdb" >}})ということを留意する.
...
-   ruberjarのビルドにはの [📝tools.build]({{< relref "20220119063524.md#tools-dot-build-clojureプロジェクトのビルドツール" >}}) のguideをみて,
