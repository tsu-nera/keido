...
ref. [オーバーライド - Wikipedia](http://ja.wikipedia.org/wiki/%E3%82%AA%E3%83%BC%E3%83%90%E3%83%BC%E3%83%A9%E3%82%A4%E3%83%89)


### オーバーライド vs オーバーロード {#オーバーライド-vs-オーバーロード}

[オーバーライド: override](#オーバーライド-override) vs [Overload: オーバーロード]({{< relref "20220310125619.md#overload-オーバーロード-多重定義" >}})

両者はタイヘン混同しやすい. とくにJavaで同じようなポリモーフィズムの実現方法として登場するので.

オーバーライドは継承に紐づく概念であり, さらにいえばオブジェクト指向に関わる. オーバーライドは [アドホック多相]({{< relref "20220310125619.md#アドホック多相" >}}) のオブジェクト指向における実現方法の呼び名.
...
ref. [Mixin - Wikipedia](https://ja.wikipedia.org/wiki/Mixin)
...
### オーバーライドとオーバーロードの共通点と違いはなんですか？ {#オーバーライドとオーバーロードの共通点と違いはなんですか}
