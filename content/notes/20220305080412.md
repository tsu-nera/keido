...
#### First Class:  第一級オブジェクト {#first-class-第一級オブジェクト}
...
### Annonimous Functions {#annonimous-functions}
...
### 関数値, 関数オブジェクト, クロージャ, ラムダ式, 無名関数の整理 {#関数値-関数オブジェクト-クロージャ-ラムダ式-無名関数の整理}
...
### impelative paradigm との違い {#impelative-paradigm-との違い}
